...
from utils.helper import convert_Btaus_to_summary_matrix, plot_summary_causal_graph
...
def save_summary_matrix(B0, B1, save_path):
    """
    Convert B0 and B1 to a summary matrix and save it to a .npy file.
    ...
    save_path : str
        Directory path to save the file.
    """
    summary_matrix = convert_Btaus_to_summary_matrix([B0, B1])
...
def plot_and_save_graph(B0, B1, save_path):
    """
    ...
    plot_summary_causal_graph([B0, B1], filename=graph_path)
...
def main():
    ...
    # Save summary matrix
    save_summary_matrix(B0_true, B1_true, SAVE_PATH)

    # Plot and save causal graph
    plot_and_save_graph(B0_true, B1_true, SAVE_PATH)
